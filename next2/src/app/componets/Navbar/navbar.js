...

            {
                navClass !== 'nav-light' ? <ul className={`buy-button list-none space-x-1 mb-0`} >
                        <li className="inline mb-0">
                            <Link href="#" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600/5 hover:bg-indigo-600 border border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"></Link>
                        </li>

                        <li className="inline ps-1 mb-0">
                            <Link href="https://1.envato.market/techwind-next" target="_blank" className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"></Link>
                        </li>
                    ...
                    <ul className="buy-button list-none space-x-1 mb-0">
                        ...
                        <li className="inline ps-1 mb-0">
                            <Link href="https://1.envato.market/techwind-next" target="_blank">
                                <div className="login-btn-primary"><span className="size-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"></span></div>
                        ...
                        <ul className="submenu megamenu">
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-ai" || "" ? "active" : ""}><Link href="/index-ai" className="sub-menu-item">AI Tools<span className="bg-black dark:bg-slate-50 inline-block text-white dark:text-slate-900 text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Dark</span></Link></li>
                            ...
                            <li>
                                <ul>
                                    <li className={manu === "/index-it-solution" || "" ? "active" : ""}><Link href="/index-it-solution" className="sub-menu-item">IT Solution 111234567</Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-life-coach" || "" ? "active" : ""}><Link href="/index-life-coach" className="sub-menu-item">Life Coach <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
                                    ...
                                    <li className={manu === "/index-christmas" || "" ? "active" : ""}><Link href="/index-christmas" className="sub-menu-item">Christmas </Link></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-classic-business" || "" ? "active" : ""}><Link href="/index-classic-business" className="sub-menu-item">Classic Business </Link></li>
                            ...
                            <li>
                                <ul>
                                    ...
                                    <li className={manu === "/index-landing-six" || "" ? "active" : ""}><Link href="/index-landing-six" className="sub-menu-item">Landing Six <span className="bg-yellow-500 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></Link></li>
